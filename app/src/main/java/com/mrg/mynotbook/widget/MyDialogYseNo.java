...
/**
 * Created by MrG on 2017-05-07.
 */
public class MyDialogYseNo extends Dialog{
    public MyDialogYseNo(Context context) {
        super(context);
    }

    public MyDialogYseNo(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public MyDialogYseNo create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final MyDialogYseNo dialog = new MyDialogYseNo(context,R.style.Dialog);
